...
class NotificationUtils {
  ...
  ************************************************ */
  ...
  static Future<void> showCallNotification(int id) async {
    String platformVersion = await GLFunc.instance.getPlatformVersion();
  ...
  ************************************************ */
  ...
  static Future<void> showBigPictureFileNotification(int id) async {
    String newFilePath = await GLFunc.instance.downloadAndSaveImageOnDisk(
      ...
      await Future.delayed(const Duration(seconds: 1), () async {
        if (simulatedStep > maxStep) {
          await AwesomeNotifications().createNotification(
              content: NotificationContent(
                  id: id,
                  //channelKey: Const.IEL_APP_CHANNEL,
                  channelKey: 'TEST',
